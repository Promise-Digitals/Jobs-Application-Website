...
const JobCard = ({job}) => {
    ...
    return (
        <div className='border border-black/20 p-6 shadow rounded'>
            ...
            <div className='mt-4 flex gap-4 text-sm'>
                <button onClick={() => {navigate(`/apply-job/${job._id}`); scrollTo(0, 0)}} className='bg-teal-600 text-white px-4 py-2 rounded'>Apply Now</button>
