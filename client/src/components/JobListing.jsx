                        ...
                        <div className='flex items-center justify-center space-x-2 mt-10'>
                            ...
                            </a>
                            {
                                Array.from({length:Math.ceil(jobs.length / 6)}).map((_ , index) => (
                                    <a href='#job-list'>
                                        <button onClick={() => setCurrentPage(index + 1)} className={`w-10 h-10 flex items-center justify-center border border-gray-300 rounded ${currentPage === index + 1 ? "bg-teal-100 text-teal-500" : "text-gray-500"}`}>{index + 1}</button>
                                    </a>
                                ))
                            }
                            <a href='#job-list'>
