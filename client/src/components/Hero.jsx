...
const Hero = () => {
    ...
    return (
        <div className='container 2xl:px-20 mx-auto my-10'>
            <div className='bg-gradient-to-r from-slate-800 to-slate-900 text-white py-16 text-center mx-2 rounded-xl'>
                <h2 className='text-2xl md:text-3xl lg:text-4xl font-medium mb-4'>Over 10,000 jobs to apply</h2>
                <p className='mb-8 max-w-xl mx-auto text-sm font-medium text-white/60 px-4'>Your Next Big Career Move Starts Right Here - Explore The Best Job Opportunities And Take The First Step Towards The Future</p>
                ...
                <div className='flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto'>
                    ...
                    <button onClick={onSearch} className='bg-teal-600 px-6 py-2 rounded text-white m-1'>Search</button>
                </div>
            </div>
