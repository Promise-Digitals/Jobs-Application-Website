                    ...
                    <tbody>
                        {viewApplicationsPageData.map((applicant, index) => (
                            <tr key={index} className='text-gray-700'>
                                ...
                                <td className='py-2 px-4 border-b border-gray-200 text-center'>{applicant.location}</td>
                                <td className='py-2 px-4 border-b border-gray-200'>
                                    <a className='bg-teal-50 text-teal-600 px-3 py-1 rounded inline-flex gap-2 items-center' href="" target='_blank'>
