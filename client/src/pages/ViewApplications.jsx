                    ...
                    <tbody>
                        {applicants.filter(item => item.jobId && item.userId).map((applicant, index) => (
                            <tr key={index} className='text-gray-700'>
                                ...
                                <td className='py-2 px-4 border-b border-gray-200 max-sm:hidden'>{applicant.jobId.jobTitle}</td>
                                <td className='py-2 px-4 border-b border-gray-200 text-center'>{applicant.jobId.location}</td>
                                <td className='py-2 px-4 border-b border-gray-200'>
                                    <a href={applicant.userId.resume} className='bg-teal-50 text-teal-600 px-3 py-1 rounded inline-flex gap-2 items-center' target='_blank'>
